/* codigo do professor Walter Mascarenhas da USP */
#include <math.h>
#include <float.h>
#include <assert.h>
#include <stdio.h>
...
//------------------------------------------------------------------------------
// permute_linhas atribui a linha p[i] da matrix src Ã  linha i da matriz dst
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// mul_lu(dst, src, int) assume que src contÃ©m l e u no formato descrito na
...
void teste(lu a_testar, gerador* exemplo, int n_exemplos)
{
  ...
  printf("%d testes nÃ£o encontram erros\n", n_exemplos - falhas);
  free(memoria);
}
